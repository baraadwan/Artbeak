...
const Footer = () => {
  ...
  return (
    <footer className="text-zinc-900 dark:text-white border-t border-zinc-200 dark:border-gray-800 font-inter bg-zinc-50 dark:bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 max-w-80">
            <div className="space-y-4">
              <motion.svg
                className="w-12 h-12 text-[#0047ff] dark:text-[#c5f011]"
                fill="currentColor"
                viewBox="0 0 25 24"
              ...
              <h3 className="text-zinc-900 dark:text-white text-xl font-semibold font-inter">
          ...
          <div className="space-y-8 grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <h4 className="text-zinc-900 dark:text-white font-semibold text-lg font-inter">
                  Work Inquiry
                </h4>
                <div className="space-y-2 text-zinc-600 dark:text-gray-300 text-sm font-inter">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1 text-zinc-600 dark:text-gray-300 text-sm font-inter">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <Link
                    href="/terms"
                    className="block text-zinc-600 dark:text-gray-300 hover:text-zinc-900 dark:hover:text-white transition-colors font-inter"
                  >
                    Terms & Conditions
                  </Link>
                  <Link
        ...
        {/* Bottom Section */}
        <div className="border-t border-zinc-200 dark:border-gray-800 pt-4 mt-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-zinc-500 dark:text-gray-400 text-sm font-inter">
